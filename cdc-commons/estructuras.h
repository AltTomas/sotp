...
enum{
	...
	D_STRUCT_NODO_ESCLAVO= 61,
	  ...
	  MASTER_YAMA_REDUCCIONL_WORKER_OK=33,
	  MASTER_YAMA_REDUCCIONL_WORKER_FALLO=34,
	  MASTER_YAMA__REDUCCIONG_WORKER_OK=35,
	  MASTER_YAMA__REDUCCIONG_WORKER_FALLO=36,
	  MASTER_YAMA_ALMACENAMIENTO_FINAL_WORKER_OK=37,
	  MASTER_YAMA_ALMACENAMIENTO_FINAL_WORKER_FALLO=38,
	  MASTER_YAMA_CONEXION_WORKER_OK = 39,
	  MASTER_YAMA_CONEXION_WORKER_FALLO=40,
	  ...
	  FS_DATANODE_PEDIDO_CONTENIDO_BLOQUE=82,
	  FS_DATANODE_ELIMINAR_BLOQUE=83,

	  ELIMINAR_BLOQUE_EXITO = 90,
